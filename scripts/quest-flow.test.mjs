...
import {SAVE_KEY,warmupSteps,steps,witnessSteps,allTasks,claims,finalWriting,restoreState,freshState} from '../js/quest-data.js';
...
test('Quest follows the full errand, returns to Sextus, announces new memories once and resets cleanly',()=>{
 ...
 try{
  ...
  quest.open('sextus');complete(finalWriting);assert.ok(quest.done);
