# Kommaland 5.1 · Lernwelt und Lernblick für Lehrkräfte
...
3. Alle alten Kommaland-Fenster schließen und die Adresse neu öffnen. Im Rucksack
   steht „Kommaland 5.1“. Vorhandene Namen/IDs bleiben erhalten; ohne Namen zuerst Name/Kürzel eintragen.
   Auch eine separat gehostete Lehrkräfte-Seite auf 5.1 aktualisieren.
...
## Neu in 5.1: Selbstregulation

Fünf getrennte Unterstützungsdimensionen, vier Navigationsstufen, sparsame Strategie-
impulse, freiwillige Gründe für Zurückstellen/Gebietswechsel, Transfer-Einladungen und
Sitzungsrückblick. Automatische Impulse teilen sich höchstens zwei Unterbrechungen pro
Sitzung und rollendem 30-Minuten-Fenster, mit mindestens fünf Minuten Abstand.
Fading benötigt sichere reguläre Arbeit **und** eigene erfolgreiche Lernentscheidungen.
Mehr Führung wird angeboten, nicht erzwungen. Neue Lehrkräfte-Ansicht: „Lernentscheidungen“.

`SELBSTREGULATION.md` beschreibt Regeln, Aktionen, Grenzen und die Architektur.
Aufgaben, Lösungen, Weltmodelle und Prüfungsregeln wurden nicht inhaltlich verändert.
