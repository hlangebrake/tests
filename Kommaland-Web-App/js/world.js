...
export class World {
 ...
 sync(state){
  ...
  for(const o of this.objects)if(o.type==='quest'){
   ...
   o.before.visible=!done&&!hidden;o.after.visible=done&&!hidden;o.after.reveal=1000;o.before.opacity=1;o.after.opacity=1;
  }
 ...
 beginBuild(id,onComplete=()=>{}){
  ...
  this.stop();
  this.building={object:o,start:this.time,duration:this.state?.settings.reducedMotion ? .25 : o.q?.challenge?4.2:2.65,onComplete,stage:0};
