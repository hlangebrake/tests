...
export function initialLab(c){
 return {n:c.type==='halves'?1:(c.n??0),a:c.a??0,b:c.b??0,whole:c.whole??0,part:c.part??0,total:c.total??0,portion:c.portion??0,digits:c.digits?[...c.digits]:null,parts:c.parts??0,selected:0,step:0,case:0,fine:false,comparison:0,order:c.values?[...c.values]:null,paint:null,story:0,stock:c.stock??0};
}
