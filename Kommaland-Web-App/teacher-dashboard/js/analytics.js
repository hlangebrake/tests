...
export function metrics(projection, {kind='regular',topicId=null,skillId=null,from='',to='9999-12-31T23:59:59.999Z'}={}){
 ...
 const q=quests.filter(q=>q.active!==false&&q.kind===kind&&(!topicId||q.topicId===topicId));
 const t=tasks.filter(t=>t.active!==false&&t.kind===kind&&(!topicId||t.topicId===topicId)&&(!skillId||t.skillId===skillId));
