import {compactLearning7} from './learning7-view.js';
...
export async function report(db,{range={},className='',kind='summary',studentId=null,bucket='day'}={}){
 ...
 for(const s of students){
  ...
  rows.push({...studentSummary(s,p,range),regulation:compactRegulation(p.events,range),learning7:compactLearning7(p.events,range)});
