...
export function validateSave(raw){
 ...
 assert(raw.schemaVersion===SCHEMA_VERSION,`Nicht unterstützte Lernstand-Version: ${String(raw.schemaVersion)}.`);
 ...
 return {format:FORMAT,schemaVersion:SCHEMA_VERSION,studentId:raw.studentId,studentName:raw.studentName,exportId:raw.exportId,exportTimestamp:raw.exportTimestamp,appVersion:raw.appVersion,currentState:structuredClone(raw.currentState),catalog,sessions,events,coverage:plain(raw.coverage)?safeData(raw.coverage):{}};
}
