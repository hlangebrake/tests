# Gemeinsames Lernstandsformat · Version 1

## Verbindliche Quelle

`shared/save-schema.js` wird von Schüler-App und Lehrkräfte-App importiert.
`SCHEMA_VERSION = 1`, `APP_VERSION = "5.0.0"`,
...
notwendig. Zukünftige Austauschformat-Versionen dürfen nicht still als Version 1
interpretiert werden. Der bisherige Import lehnt unbekannte Versionen verständlich ab.
